...
clang -ggdb -std=c17 -o build/tira_tests -DDEBUG \
    src/tester.c src/platform_linux.c src/string.c src/memory.c src/son.c src/print.c src/lexer.c src/ddcg.c src/runtime.c src/semantic.c \
